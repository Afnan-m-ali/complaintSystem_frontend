      ...
      <div className="bg-white shadow-2xl rounded-3xl p-10 w-full max-w-3xl">
        ...
        <div className="flex flex-col items-center space-y-4 mb-8">
          <img
            ...
            alt="Profile Avatar"
            className="w-32 h-32 rounded-full shadow-lg border-4 border-pink-500"
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-pink-50 p-6 rounded-2xl shadow-inner">
        ...
        <div className="flex flex-col space-y-4 items-center">
          ...
          <Link
            ...
            className="px-8 py-4 text-lg font-semibold bg-purple-600 text-white rounded-2xl shadow-lg hover:bg-purple-700 transition w-full text-center"
          >
            📝 View All Complaints
          </Link>
        </div>
