...
//     try {
//       const res = await fetch("http://127.0.0.1:8000/members/departments/add/", {
//         method: "POST",
...
//   return (
//     <div className="max-w-lg mx-auto mt-10 p-6 bg-gray-800 border border-gray-700 rounded-lg shadow-lg text-gray-100 transition-colors">
...
//           <button
//             type="submit"
//             className="px-4 py-2 bg-blue-800 hover:bg-blue-700 text-white text-sm rounded-md shadow transition"
//           >
//             Save
//           </button>
//           <button
...
//             className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm rounded-md shadow transition"
//           >
//             Save & Add Another
//           </button>
//         </div>
